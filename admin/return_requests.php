                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                            ...
                            // $sql="select BookId,RollNo,Title,datediff(curdate(),Due_Date) as x from return,book,record where BookId=BookId and BookId=BookId and RollNo=RollNo";


                            $sql = "SELECT return.BookId, return.RollNo, book.Title, DATEDIFF(CURDATE(), record.Due_Date) AS x
                            FROM `return`
                            JOIN book ON return.BookId = book.BookId
                            JOIN record ON return.BookId = record.BookId AND return.RollNo = record.RollNo;
                            ";
